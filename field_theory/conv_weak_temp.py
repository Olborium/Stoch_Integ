...
ax.errorbar(DTs, np.abs(TeffSho/TEMP-1), 2*TeffShoE/TEMP, color='red', fmt='o', ms=5, markerfacecolor='red', elinewidth=1, capsize=2)
ax.errorbar(DTs, np.abs(TeffLon/TEMP-1), 2*TeffLonE/TEMP, color='blue', fmt='s', ms=5, markerfacecolor='blue', elinewidth=1, capsize=2)
